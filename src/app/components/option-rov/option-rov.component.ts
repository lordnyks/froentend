...
export class OptionRovComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private validation: ValidationFieldsService, private userProfile: UserProfileComponent, private authService: AuthService, private dialog: MatDialog, public expirations: ExpirationsService) { }
